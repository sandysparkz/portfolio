(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,87316,e=>{"use strict";let t=(0,e.i(75254).default)("calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]);e.s(["Calendar",0,t],87316)},63059,e=>{"use strict";let t=(0,e.i(75254).default)("chevron-right",[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]]);e.s(["ChevronRight",0,t],63059)},27925,e=>{"use strict";var t=e.i(43476),r=e.i(71645),a=e.i(22016),s=e.i(87316),l=e.i(75254);let i=(0,l.default)("book-open",[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]]);var n=e.i(63059);let o=(0,l.default)("search",[["path",{d:"m21 21-4.34-4.34",key:"14j7rj"}],["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}]]),c=(0,l.default)("tag",[["path",{d:"M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z",key:"vktsd0"}],["circle",{cx:"7.5",cy:"7.5",r:".5",fill:"currentColor",key:"kqv944"}]]),d=(0,l.default)("arrow-left",[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]]),h=[{slug:"getting-started-zephyr-usb",title:"[Blog Title — Getting Started with Zephyr's USB Subsystem]",date:"2024-01-15",author:"[Your Name]",excerpt:"[Excerpt Placeholder — A deep dive into configuring and using the USB subsystem in Zephyr RTOS...]",tags:["Zephyr","USB","Tutorial"],readTime:"8 min read",content:`
...
MODULE_DESCRIPTION("A simple kernel module");</code></pre>
    ...
    `}],p=Array.from(new Set(h.flatMap(e=>e.tags))).sort();e.s(["default",0,function(){let[e,l]=(0,r.useState)(""),[m,u]=(0,r.useState)(null),x=h.filter(t=>{let r=t.title.toLowerCase().includes(e.toLowerCase())||t.excerpt.toLowerCase().includes(e.toLowerCase()),a=!m||t.tags.includes(m);return r&&a});return(0,t.jsx)("div",{className:"min-h-screen pt-24 pb-16",children:(0,t.jsxs)("div",{className:"max-w-4xl mx-auto px-4 sm:px-6",children:[(0,t.jsxs)(a.default,{href:"/",className:"inline-flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 hover:text-accent-600 dark:hover:text-accent-400 mb-8 transition-colors",children:[(0,t.jsx)(d,{className:"w-4 h-4"}),"Back to Portfolio"]}),(0,t.jsxs)("div",{className:"mb-12",children:[(0,t.jsx)("h1",{className:"text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4",children:"Blog"}),(0,t.jsx)("p",{className:"text-lg text-gray-500 dark:text-gray-400",children:"Deep dives into embedded systems, firmware development, and low-level engineering — straight from the terminal."})]}),(0,t.jsxs)("div",{className:"mb-10 space-y-4",children:[(0,t.jsxs)("div",{className:"relative",children:[(0,t.jsx)(o,{className:"absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"}),(0,t.jsx)("input",{type:"text",placeholder:"Search articles...",className:"input-field pl-12 text-base",value:e,onChange:e=>l(e.target.value)})]}),(0,t.jsxs)("div",{className:"flex items-center gap-2 flex-wrap",children:[(0,t.jsx)(c,{className:"w-4 h-4 text-gray-400"}),(0,t.jsx)("button",{onClick:()=>u(null),className:`px-3 py-1.5 rounded-lg font-mono text-xs transition-all ${null===m?"bg-accent-600 text-white":"bg-gray-100 dark:bg-surface-dark-card border border-gray-200 dark:border-surface-dark-border text-gray-600 dark:text-gray-400 hover:border-accent-300 dark:hover:border-accent-700"}`,children:"All"}),p.map(e=>(0,t.jsx)("button",{onClick:()=>u(e===m?null:e),className:`px-3 py-1.5 rounded-lg font-mono text-xs transition-all ${m===e?"bg-accent-600 text-white":"bg-gray-100 dark:bg-surface-dark-card border border-gray-200 dark:border-surface-dark-border text-gray-600 dark:text-gray-400 hover:border-accent-300 dark:hover:border-accent-700"}`,children:e},e))]})]}),(0,t.jsxs)("p",{className:"font-mono text-sm text-gray-400 mb-6",children:[x.length," article",1!==x.length?"s":""," ","found"]}),(0,t.jsxs)("div",{className:"space-y-4",children:[x.map(e=>(0,t.jsx)(a.default,{href:`/blog/${e.slug}`,className:"card-interactive group block",children:(0,t.jsxs)("div",{className:"flex flex-col sm:flex-row sm:items-start gap-4",children:[(0,t.jsxs)("div",{className:"flex-1",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3 mb-2",children:[(0,t.jsxs)("div",{className:"flex items-center gap-1.5 text-gray-400",children:[(0,t.jsx)(s.Calendar,{className:"w-3.5 h-3.5"}),(0,t.jsx)("span",{className:"font-mono text-xs",children:e.date})]}),(0,t.jsx)("span",{className:"text-gray-300 dark:text-gray-600",children:"•"}),(0,t.jsxs)("div",{className:"flex items-center gap-1.5 text-gray-400",children:[(0,t.jsx)(i,{className:"w-3.5 h-3.5"}),(0,t.jsx)("span",{className:"font-mono text-xs",children:e.readTime})]})]}),(0,t.jsx)("h2",{className:"text-lg font-semibold text-gray-900 dark:text-white group-hover:text-accent-600 dark:group-hover:text-accent-400 transition-colors mb-2",children:e.title}),(0,t.jsx)("p",{className:"text-sm text-gray-500 dark:text-gray-400 line-clamp-2 mb-3",children:e.excerpt}),(0,t.jsx)("div",{className:"flex flex-wrap gap-2",children:e.tags.map(e=>(0,t.jsx)("span",{className:"tech-tag text-xs",children:e},e))})]}),(0,t.jsx)("div",{className:"hidden sm:flex items-center text-accent-500 opacity-0 group-hover:opacity-100 transition-opacity",children:(0,t.jsx)(n.ChevronRight,{className:"w-5 h-5"})})]})},e.slug)),0===x.length&&(0,t.jsxs)("div",{className:"text-center py-16",children:[(0,t.jsxs)("p",{className:"font-mono text-gray-400 mb-2",children:['$ grep -r "',e||m,'" ./blog/']}),(0,t.jsx)("p",{className:"text-gray-500 dark:text-gray-400",children:"No articles found. Try a different search or filter."})]})]})]})})}],27925)}]);