(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,63059,e=>{"use strict";let t=(0,e.i(75254).default)("chevron-right",[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]]);e.s(["ChevronRight",0,t],63059)},87316,e=>{"use strict";let t=(0,e.i(75254).default)("calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]);e.s(["Calendar",0,t],87316)},55436,e=>{"use strict";let t=(0,e.i(75254).default)("search",[["path",{d:"m21 21-4.34-4.34",key:"14j7rj"}],["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}]]);e.s(["Search",0,t],55436)},71689,e=>{"use strict";let t=(0,e.i(75254).default)("arrow-left",[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]]);e.s(["ArrowLeft",0,t],71689)},27925,e=>{"use strict";var t=e.i(43476),s=e.i(71645),r=e.i(22016),a=e.i(87316),l=e.i(75254);let i=(0,l.default)("book-open",[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]]);var n=e.i(63059),o=e.i(55436),c=e.i(37727),d=e.i(71689);let h=(0,l.default)("tag",[["path",{d:"M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z",key:"vktsd0"}],["circle",{cx:"7.5",cy:"7.5",r:".5",fill:"currentColor",key:"kqv944"}]]),p=[{slug:"getting-started-zephyr-usb",title:"[Blog Title — Getting Started with Zephyr's USB Subsystem]",date:"2024-01-15",author:"[Your Name]",excerpt:"[Excerpt Placeholder — A deep dive into configuring and using the USB subsystem in Zephyr RTOS...]",tags:["Zephyr","USB","Tutorial"],readTime:"8 min read",content:`
...
MODULE_DESCRIPTION("A simple kernel module");</code></pre>
    ...
    `}],u=Array.from(new Set(p.flatMap(e=>e.tags))).sort();e.s(["default",0,function(){let[e,l]=(0,s.useState)(""),[m,g]=(0,s.useState)(null),x=(0,s.useRef)(null);(0,s.useEffect)(()=>{let e=e=>{"Escape"===e.key&&document.activeElement===x.current&&(l(""),x.current?.blur())};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]);let b=p.filter(t=>{let s=t.title.toLowerCase().includes(e.toLowerCase())||t.excerpt.toLowerCase().includes(e.toLowerCase())||t.tags.some(t=>t.toLowerCase().includes(e.toLowerCase())),r=!m||t.tags.includes(m);return s&&r});return(0,t.jsx)("div",{className:"min-h-screen pt-28 sm:pt-36 pb-20 sm:pb-28",children:(0,t.jsxs)("div",{className:"max-w-6xl mx-auto px-4 sm:px-6 lg:px-8",children:[(0,t.jsxs)(r.default,{href:"/#blog-teaser",className:"inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-blue-400 transition-colors duration-200 mb-10",children:[(0,t.jsx)(d.ArrowLeft,{className:"w-4 h-4"}),"Back to home"]}),(0,t.jsxs)("div",{className:"mb-12 sm:mb-14",children:[(0,t.jsxs)("div",{className:"section-label",children:[(0,t.jsx)("div",{className:"section-label-line"}),(0,t.jsx)("span",{className:"section-label-text",children:"Blog"})]}),(0,t.jsx)("h1",{className:"section-title uppercase",children:"All Posts"}),(0,t.jsx)("p",{className:"section-subtitle",children:"Deep dives into embedded systems, firmware development, and low-level engineering."})]}),(0,t.jsxs)("div",{className:"relative mb-6",children:[(0,t.jsx)(o.Search,{className:"absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 pointer-events-none"}),(0,t.jsx)("input",{ref:x,type:"text",placeholder:"Search articles...",value:e,onChange:e=>l(e.target.value),className:"input-field w-full pl-12 pr-10 py-2.5 text-sm"}),e&&(0,t.jsx)("button",{onClick:()=>{l(""),x.current?.focus()},className:"absolute right-3 top-1/2 -translate-y-1/2 p-1 rounded text-gray-500 hover:text-gray-200 transition-colors","aria-label":"Clear search",children:(0,t.jsx)(c.X,{className:"w-3.5 h-3.5"})})]}),(0,t.jsxs)("div",{className:"flex items-center gap-2 flex-wrap mb-10",children:[(0,t.jsx)(h,{className:"w-4 h-4 text-gray-600"}),(0,t.jsx)("button",{onClick:()=>g(null),className:"px-3 py-1.5 rounded-lg text-xs uppercase tracking-wide font-mono transition-all duration-200",style:{background:null===m?"rgba(255,255,255,0.95)":"rgba(255,255,255,0.04)",color:null===m?"#0e0e0e":"#6b7280",border:null===m?"1px solid rgba(255,255,255,0.2)":"1px solid rgba(255,255,255,0.08)"},children:"All"}),u.map(e=>(0,t.jsx)("button",{onClick:()=>g(e===m?null:e),className:"px-3 py-1.5 rounded-lg text-xs uppercase tracking-wide font-mono transition-all duration-200",style:{background:e===m?"rgba(255,255,255,0.95)":"rgba(255,255,255,0.04)",color:e===m?"#0e0e0e":"#6b7280",border:e===m?"1px solid rgba(255,255,255,0.2)":"1px solid rgba(255,255,255,0.08)"},children:e.toUpperCase()},e))]}),(0,t.jsxs)("p",{className:"font-terminal text-xs text-gray-600 mb-6",children:[b.length," article",1!==b.length?"s":""," found"]}),(0,t.jsxs)("div",{className:"space-y-4",children:[b.map(e=>(0,t.jsx)(r.default,{href:`/blog/${e.slug}`,className:"card-interactive group block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500",children:(0,t.jsxs)("div",{className:"flex flex-col sm:flex-row sm:items-start gap-4",children:[(0,t.jsxs)("div",{className:"flex-1",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3 mb-2",children:[(0,t.jsxs)("div",{className:"flex items-center gap-1.5 text-gray-600",children:[(0,t.jsx)(a.Calendar,{className:"w-3.5 h-3.5"}),(0,t.jsx)("span",{className:"font-mono text-xs",children:e.date})]}),(0,t.jsx)("span",{className:"text-gray-700",children:"·"}),(0,t.jsxs)("div",{className:"flex items-center gap-1.5 text-gray-600",children:[(0,t.jsx)(i,{className:"w-3.5 h-3.5"}),(0,t.jsx)("span",{className:"font-mono text-xs",children:e.readTime})]})]}),(0,t.jsx)("h2",{className:"text-base font-semibold text-gray-300 group-hover:text-blue-300 transition-colors duration-200 mb-2 uppercase tracking-wide",children:e.title}),(0,t.jsx)("p",{className:"text-sm text-gray-600 line-clamp-2 mb-3",children:e.excerpt}),(0,t.jsx)("div",{className:"flex flex-wrap gap-2",children:e.tags.map(e=>(0,t.jsx)("span",{className:"tech-tag uppercase",children:e.toUpperCase()},e))})]}),(0,t.jsx)("div",{className:"hidden sm:flex items-center text-gray-600 group-hover:text-blue-400 transition-colors duration-200",children:(0,t.jsx)(n.ChevronRight,{className:"w-5 h-5"})})]})},e.slug)),0===b.length&&(0,t.jsxs)("div",{className:"text-center py-16",children:[(0,t.jsxs)("p",{className:"font-terminal text-gray-500 text-sm mb-2",children:['$ grep -r "',e||m,'" ./blog/']}),(0,t.jsx)("p",{className:"text-gray-600 text-xs",children:"No articles found. Try a different search or filter."})]})]})]})})}],27925)}]);